 ...
 */
final class Version20210411092929 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE "group_item" (id BIGSERIAL NOT NULL, group_id BIGINT DEFAULT NULL, skill_group_item BIGINT DEFAULT NULL, teacher_group_item BIGINT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX group_item__group_id__ind ON "group_item" (group_id)');
        $this->addSql('CREATE INDEX group_item__skill_group_item__ind ON "group_item" (skill_group_item)');
        $this->addSql('CREATE INDEX group_item__teacher_group_item__ind ON "group_item" (teacher_group_item)');
